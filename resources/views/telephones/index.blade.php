<x-app-layout>
    ...
    <div class="container max-w-6xl mx-auto mt-20">
        <h1 class="font-serif text-3xl font-bold underline decoration-gray-400"> Telephone Index</h1>
        ...
        <div class="flex justify-end">
            <a href="{{ route('telephones.create')}}"
               class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">Add Telephone</a>
        </div>
    </div>
                ...
                <table class="min-w-full">
                    ...
                    <tr>
                        ...
                        <td class="text-sm font-medium leading-5 whitespace-no-wrap border-c border-gray-200">
                            <form action="{{route('telephones.destroy', $phone->hashid)}}" method="POST" onsubmit="return confirm('{{trans('Are you sure?')}}');">
